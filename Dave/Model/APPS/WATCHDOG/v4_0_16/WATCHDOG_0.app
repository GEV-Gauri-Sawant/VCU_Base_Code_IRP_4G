...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="WATCHDOG" URI="http://resources/4.0.16/app/WATCHDOG/0" description="Provides interface to configure watchdog timer." mode="NOTSHARABLE" version="4.0.16" minDaveVersion="4.0.0" instanceLabel="WATCHDOG_0" appLabel="" containingProxySignal="true">
  ...
  <requiredApps URI="http://resources/4.0.16/app/WATCHDOG/0/appres_clockapp" requiredAppName="CLOCK_XMC4" requiringMode="SHARABLE">
    <downwardMapList xsi:type="ResourceModel:App" href="../../CLOCK_XMC4/v4_0_24/CLOCK_XMC4_0.app#/"/>
  </requiredApps>
  <requiredApps URI="http://resources/4.0.16/app/WATCHDOG/0/appres_scuglobalapp" requiredAppName="GLOBAL_SCU_XMC4" required="false" requiringMode="SHARABLE"/>
  <requiredApps URI="http://resources/4.0.16/app/WATCHDOG/0/appres_cpuctrlapp" requiredAppName="CPU_CTRL_XMC4" requiringMode="SHARABLE">
  ...
  <connections URI="http://resources/4.0.16/app/WATCHDOG/0/http://resources/4.0.16/app/WATCHDOG/0/vs_watchdog_prewarn_int/http://resources/4.0.16/app/WATCHDOG/0/vs_scuglobalapp_node" systemDefined="true" sourceSignal="event_pre_warning" targetSignal="sr_irq0" required="false" srcVirtualSignal="//@virtualSignals.1" proxyTargetVirtualSignalUri="http://resources/4.1.14/app/GLOBAL_SCU_XMC4/0/vs_nvic_signal_in" containingProxySignal="true"/>
  <connections URI="http://resources/4.0.16/app/WATCHDOG/0/http://resources/4.0.16/app/WATCHDOG/0/vs_watchdog_prewarn_int/http://resources/4.0.16/app/WATCHDOG/0/vs_cpuctrllapp_node" systemDefined="true" sourceSignal="event_pre_warning" targetSignal="nmi_irq" srcVirtualSignal="//@virtualSignals.1" proxyTargetVirtualSignalUri="http://resources/4.0.18/app/CPU_CTRL_XMC4/0/vs_nmi_irq" containingProxySignal="true">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="../../CPU_CTRL_XMC4/v4_0_18/CPU_CTRL_XMC4_0.app#//@virtualSignals.0"/>
    <targetVirtualSignal href="../../CPU_CTRL_XMC4/v4_0_18/CPU_CTRL_XMC4_0.app#//@virtualSignals.0"/>
  </connections>
</ResourceModel:App>
